// icon:box-arrow-up-right | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from "react";

function IconBoxArrowUpRight(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export default IconBoxArrowUpRight;
